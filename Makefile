...
all: $(POLICY_ENGINE_EXE) $(PROXY_EXE) $(PYTHON_PLUGINS_ADDON_SO) $(OPENSSL_TEST_PLUGIN_SO) $(RAW_TEST_PLUGIN_SO) $(SIMPLE_SERVER_EXE) $(SIMPLE_CLIENT_EXE) $(CERT_TEST_EXE)
...
clean:
	...
	rm -rf *.o *.so $(PYTHON_PLUGINS_ADDON_SO) $(OPENSSL_TEST_PLUGIN_SO) $(RAW_TEST_PLUGIN_SO) $(POLICY_ENGINE_EXE) $(PROXY_EXE) $(SIMPLE_SERVER_EXE) $(SIMPLE_CLIENT_EXE) $(CERT_TEST_EXE)
